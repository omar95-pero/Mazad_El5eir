...
@section('title')
    <li class="m-nav__item">
        <a href="{{route('UsersIndex')}}" class="m-nav__link">
            <span class="m-nav__link-text">المستخدمين</span>
        </a>
    </li>
    <li class="m-nav__separator">-</li>
    <li class="m-nav__item">
        <a href="{{route('UserCreate')}}" class="m-nav__link">
    ...
    <div class="main_cotent">
        <div class="box" style="margin: 25px 0px;">
            ...
            <div class="box">
                ...
                <form method="POST" action="{{route('UserStore')}}" accept-charset="UTF-8" enctype="multipart/form-data">
...
{{--                        </div>--}}
                        ...
                        <input class="form-control" name="phone_number" type="text" id="phone" placeholder="رقم التليفون..."  data-validation="">   </div>
                    </div>
            </div>
