                    ...
                    <div class="d-table">
                        <div class="d-table-cell">
                            <div class="user-content-inner">
                                ...
                                <div class="card-body">
                                    @foreach($user as $usr)
                                    <form method="POST" action="{{route('Verification',$usr->id)}}">
                                        @csrf
                                        <div class="form-group row">
                                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('ادخل الكود الذي تم ارساله لبريدك الاكتروني') }}</label>

                                            <div class="col-md-8">
                                                <input id="email" type="text" class="form-control" name="code">
                                                <input type="hidden" value="{{$usr->email}}">
