    ...
    <div class="container-fluid p-0">
      <div class="row m-0">
        ...
        <div class="col-lg-5 p-0 img-col-6">
          ...
          <div class="user-img" style="background-image: url(img/login.jpg);">
                  ...
                  <form>
                    <div class="row">
                      ...
                      <div class="col-lg-12 d-flex align-items-center justify-content-center">
                        <button type="submit" class="btn common-btn">دخول</button>
                      </div>
                    </div>
                  </form>
                  <div class="bottom">
                    <p>لا تملك حساب ؟ <a href="register.html">إنشاء حساب</a></p>
                    <h4>أو</h4>
                    <ul>
                      <li>
