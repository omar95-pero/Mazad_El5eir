...
{{--                    </div>--}}
                    <div class="tab-pane fade" id="profile-just" role="tabpanel" aria-labelledby="profile-tab-just">--}}
                        <div class="container  ">
                            ...
                            <section class="donations-area pt-5 pb-4">
                                ...
                                <div class="row">
                                    @foreach($myFavorite as  $val)
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="donation-item">
                                                <div class="img">
                                                    <img src="{{get_file($val->auction->image)}}" alt="Donation">
                                                    <a class="common-btn" href="{{ route('auction.details',$val->auction->id) }}">تفاصيل المزاد</a>
                                                </div>
                                                <div class="inner">
                                                    <div class="top">
                                                        {{--                                                                      <a class="tags" href="#">#{{$val->charity->name}}</a>--}}
                                                        <h3>
                                                            <a href="#">مزاد على {{$val->auction->item_name}}</a>
                                                        </h3>
                                                        <p>{{$val->auction->item_detailes}}
                                                        </p>
                                                    </div>
                                                    <div class="bottom">
                                                        <div class="skill">
                                                        ...
                                                        <ul>
                                                            <li> أخر سعر : <strong> 5,500 $ </strong> </li>
                                                            <li> سعر مزادي : <strong>{{$val->auction->start_price}}<i class="fad fa-arrow-down px-2"></i></strong> </li>
                                                        </ul>
                                                        <!-- <h4> <span> 60 شخص </span> قاموا بالمزايدة </h4> -->
                                                    </div>
                                                </div>
    ...
    <a href="AuctionAdd.html" class="AuctionAdd"><i class="far fa-plus"></i></a>
