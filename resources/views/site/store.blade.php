...
{{--  </section>--}}
  ...
  <div class="terms mt-5" style="margin-top: 100px !important;">
...
{{--          </p>--}}
           <div class="w-100 d-flex align-items-center justify-content-center py-3">
                <img src="{{asset('assets/img/store.jpeg')}}" style="width: 100%; height: 500px;">
           </div>
        </div>
